...
public partial class HozeB : System.Web.UI.Page
{
    ...
    private void setVisibility()
    {
        ...
        //bt_1_1_hoze_upload.Visible = !(bt_1_1_hoze_watch.Visible = (Directory.GetFiles(Server.MapPath("~/files/hozeB/"), date + "menashe_hoze.*").Length > 0));
        //bt_1_1_kamuyot_upload.Visible = !(bt_1_1_kamuyot_watch.Visible = (Directory.GetFiles(Server.MapPath("~/files/hozeB/"), date + "menashe_kamuyot.pdf").Length > 0));
        //bt_1_2_hoze_upload.Visible = !(bt_1_2_hoze_watch.Visible = (Directory.GetFiles(Server.MapPath("~/files/hozeB/"), date + "efraim_hoze.pdf").Length > 0));
        //bt_1_2_kamuyot_upload.Visible = !(bt_1_2_kamuyot_watch.Visible = (Directory.GetFiles(Server.MapPath("~/files/hozeB/"), date + "efraim_kamuyot.pdf").Length > 0));
        //bt_1_3_hoze_upload.Visible = !(bt_1_3_hoze_watch.Visible = (Directory.GetFiles(Server.MapPath("~/files/hozeB/"), date + "binyamin_hoze.*").Length > 0));
        //bt_1_3_kamuyot_upload.Visible = !(bt_1_3_kamuyot_watch.Visible = (Directory.GetFiles(Server.MapPath("~/files/hozeB/"), date + "binyamin_kamuyot.*").Length > 0));
        //bt_1_4_hoze_upload.Visible = !(bt_1_4_hoze_watch.Visible = (Directory.GetFiles(Server.MapPath("~/files/hozeB/"), date + "jerusalem_hoze.*").Length > 0));
        //bt_1_4_kamuyot_upload.Visible = !(bt_1_4_kamuyot_watch.Visible = (Directory.GetFiles(Server.MapPath("~/files/hozeB/"), date + "jerusalem_kamuyot.*").Length > 0));
        //bt_1_5_hoze_upload.Visible = !(bt_1_5_hoze_watch.Visible = (Directory.GetFiles(Server.MapPath("~/files/hozeB/"), date + "yehuda_hoze.*").Length > 0));
        //bt_1_5_kamuyot_upload.Visible = !(bt_1_5_kamuyot_watch.Visible = (Directory.GetFiles(Server.MapPath("~/files/hozeB/"), date + "yehuda_kamuyot.*").Length > 0));
    }
    ...
    {
        string path = Server.MapPath("~/data/hozeB.txt");
        if (File.Exists(path))
        {
    ...
    {
        File.Delete(Server.MapPath("~/data/hozeB.txt"));
        Response.Redirect("hozeB.aspx");
        LoadFile();
        setVisibility();
    }
